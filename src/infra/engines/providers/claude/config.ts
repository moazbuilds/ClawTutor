 ...
 */
export const ENV = {
  CLAUDE_HOME: 'CLAWTUTOR_CLAUDE_HOME',
  ANTHROPIC_BASE_URL: 'CLAWTUTOR_ANTHROPIC_BASE_URL',
  ANTHROPIC_AUTH_TOKEN: 'CLAWTUTOR_ANTHROPIC_AUTH_TOKEN',
  ANTHROPIC_API_KEY: 'CLAWTUTOR_ANTHROPIC_API_KEY',
  CLAUDE_OAUTH_TOKEN: 'CLAWTUTOR_CLAUDE_OAUTH_TOKEN',
} as const;
