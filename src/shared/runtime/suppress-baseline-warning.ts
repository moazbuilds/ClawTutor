...
const globalWithFlag = globalThis as typeof globalThis & {
  __CLAWTUTOR_BASELINE_BBM_WARN_FILTER__?: boolean;
};

if (!globalWithFlag.__CLAWTUTOR_BASELINE_BBM_WARN_FILTER__) {
  globalWithFlag.__CLAWTUTOR_BASELINE_BBM_WARN_FILTER__ = true;
